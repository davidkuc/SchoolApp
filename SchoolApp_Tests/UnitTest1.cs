...
namespace SchoolApp_Tests
{
    ...
    public class UnitTest1
    {
        ...
        public void SqlRepository_Add()
        {
            ...
            var expStud = new Student { ID = "9", Name = "Stud9", Surname = "Sur9", CourseName = "ddd", DateOfBirth = "55/55/5555", Year = 1 };
            sqlRepo.Add(new Student { Name = "Stud9", Surname = "Sur9", CourseName = "ddd", DateOfBirth = "55/55/5555", Year = 1 });
